...
annotation('textbox', [0 0.9 1 0.1], ...
    'String', 'Subject 1 Before Biofeedback', ...
    'EdgeColor', 'none', ...
    'FontWeight', 'bold', ...
...
figure
annotation('textbox', [0 0.9 1 0.1], ...
    'String', 'Subject 1 After Biofeedback', ...
    'EdgeColor', 'none', ...
    'FontWeight', 'bold', ...
    'HorizontalAlignment', 'center')
sub1 = subplot(3,1,1);
...
figure
annotation('textbox', [0 0.9 1 0.1], ...
    'String', 'Subject 2 Before Biofeedback', ...
    'EdgeColor', 'none', ...
    'FontWeight', 'bold', ...
    'HorizontalAlignment', 'center')
sub1 = subplot(3,1,1);
...
figure
annotation('textbox', [0 0.9 1 0.1], ...
    'String', 'Subject 2 After Biofeedback', ...
    'EdgeColor', 'none', ...
    'FontWeight', 'bold', ...
    'HorizontalAlignment', 'center')
sub1 = subplot(3,1,1);
...
figure
annotation('textbox', [0 0.9 1 0.1], ...
    'String', 'Subject 3 Before Biofeedback', ...
    'EdgeColor', 'none', ...
    'FontWeight', 'bold', ...
    'HorizontalAlignment', 'center')
sub1 = subplot(3,1,1);
...
figure
annotation('textbox', [0 0.9 1 0.1], ...
    'String', 'Subject 3 After Biofeedback', ...
    'EdgeColor', 'none', ...
    'FontWeight', 'bold', ...
    'HorizontalAlignment', 'center')
sub1 = subplot(3,1,1);
...
figure
annotation('textbox', [0 0.9 1 0.1], ...
    'String', 'Subject 4 Before Biofeedback', ...
    'EdgeColor', 'none', ...
    'FontWeight', 'bold', ...
    'HorizontalAlignment', 'center')
sub1 = subplot(3,1,1);
...
figure
annotation('textbox', [0 0.9 1 0.1], ...
    'String', 'Subject 4 After Biofeedback', ...
    'EdgeColor', 'none', ...
    'FontWeight', 'bold', ...
    'HorizontalAlignment', 'center')
sub1 = subplot(3,1,1);
